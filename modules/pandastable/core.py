...
class Table(Canvas):
    ...
    def __init__(self, parent=None, model=None, dataframe=None,
        ...
        # changed
        self.ostyp = platform ##from InstantClue
    ...
    def doBindings(self):
        ...
        # changed
        self.bind(right_click, self.handle_right_click)
       # if self.ostyp=='MAC':
    ...
    def setColumnType(self):
        ...
        df = self.model.df
        col = df.columns[self.currentcol]
        ## changed - in Instant Clue only these three data types are distinguished
        coltypes = ['object','int','float64']
        curr = df[col].dtype
    ...
    def showInfo(self):
        ...
        return
        ### CHANGED !!!
    def saveCurrentDf(self,format_type):
    	"""
    	saves current data frame to selected mode
    	edited by hnolte in making pandastable in line with instant clue
    	"""
    	data = self.model.df
    	if format_type == 'txt':
    ...
    def popupMenu(self, event, rows=None, cols=None, outside=None):
        ...
        main = ["Copy", "Clear Data"]#"Undo", "Fill Down", #"Fill Right",
                #, "Delete Column(s)"]
